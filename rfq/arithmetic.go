...
//
// TODO(roasbeef): result so all checked by default?
type Int[N any] interface {
	// Assert that the target type of this interface satisfies the
	// Arithmetic interface. This let's us get around limitations re
	// recursive types in Go.
	Arithmetic[N]
...
// BigInt is a concrete implementation of the Int interface for the set of
