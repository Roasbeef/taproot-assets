...
type MultiverseArchive interface {
	...
	// FetchMultiverseLeaves returns the set of multiverse leaves that
	// satisfy the set of universe targets. If the set of targets is empty,
	// all leaves for the given proof type will be returned.
	FetchMultiverseLeaves(ctx context.Context,
		universeTargets []MultiverseLeafDesc,
