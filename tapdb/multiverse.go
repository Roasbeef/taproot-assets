...
) (fn.Option[universe.MultiverseRoot], error) {
...
// FetchMultiverseLeaves returns the set of multiverse leaves for the given
// proof type, asset ID, and group key. If both asset ID and group key is nil,
// all leaves for the given proof type will be returned.
func (b *MultiverseStore) FetchMultiverseLeaves(ctx context.Context,
